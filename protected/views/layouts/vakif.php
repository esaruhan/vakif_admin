...
<table id="email_template" width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD" style="margin:0; padding:0; border:0;">
	...
	<tr>
		...
		<td colspan="3" width="540" height="60" bgcolor="#FFFFFF" style="text-align:center;">
			<div style="margin:10px 0; font-family:'Helvatica Nue', Arial, Helvetica, sans-serif;color:#666666;font-size:20px;font-weight:bold;line-height:1"><span id="status_title" style="line-height:30px">Kurban Bağış</span>
            </div>
...
<p style="font-family:'Helvatica Nue', Arial, Helvetica, sans-serif;color:#666666;font-size:14px">
	...
	<tr>
		<td colspan="3" width="540" height="243" bgcolor="#FFFFFF" >
			<img id="image" src="<?php  if(isset($data['kurban_image'])) echo Yii::app()->getBaseUrl(true).$data['kurban_image'];  ?>" width="540" height="243" alt="" /></td>
	</tr>
	<tr>
